...
La versione 2.3.4 supporta tutti i 18 Comuni CBBO con sorgente online, cache e profili locali 2026 di fallback.
...
Dalla versione **2.3.4** l'integrazione aggiunge una voce **CBBO Waste Collection**
...
La versione 2.3.4 introduce una testata compatta e integrata con Home Assistant, nello stesso stile visuale di PawBook.

La versione 2.3.4 introduce il nuovo Waste Center con navigazione in stile Inverter Dashboard.

La v2.3.4 migliora la grafica della Waste Center con icone dei rifiuti più grandi e una gerarchia visiva più marcata.
