...
from .recycling_centers import RECYCLING_CENTERS, RECYCLING_CENTERS_VERIFIED

PANEL_COMPONENT = "cbbo-waste-collection-panel-v300"
...
def _entry_payload(entry: Any) -> dict[str, Any] | None:
    ...
    return {
        ...
        "upcoming": upcoming,
        "recycling_center": RECYCLING_CENTERS.get(municipality),
    }
...
def websocket_panel_data(
    ...
    connection.send_result(
        msg["id"],
        {
            ...
            "recycling_centers_verified": RECYCLING_CENTERS_VERIFIED,
        },
    )
...
async def async_setup_panel(hass: HomeAssistant) -> None:
    ...
    if not frontend.async_panel_exists(hass, PANEL_URL_PATH):
        await panel_custom.async_register_panel(
            ...
            module_url=f"{PANEL_JS_URL}?v=3.0.0-20260826",
            require_admin=False,
        )
