...
def test_panel_assets_and_version():
    ...
    assert "cbbo-waste-collection-panel-v235" in panel
...
def test_v235_inverter_style_shell_and_views():
    panel = (INTEGRATION / "frontend" / "cbbo-panel.js").read_text()
    ...
    backend = (INTEGRATION / "panel.py").read_text()
    assert 'PANEL_COMPONENT = "cbbo-waste-collection-panel-v235"' in backend
