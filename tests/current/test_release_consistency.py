...
def test_release_consistency():
    ...
    assert '"version": "2.4.0"' in panel_py
    assert "?v=2.4.0" in panel_py
    assert 'CBBO_PANEL_VERSION = "2.4.0"' in panel_js
    assert "cbbo-waste-collection-panel-v240" in panel_js
