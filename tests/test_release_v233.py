...
def test_release_version_consistency():
    ...
    assert '"version": "2.3.3"' in panel_py
    assert "?v=2.3.3" in panel_py
    assert 'CBBO_PANEL_VERSION = "2.3.3"' in panel_js
    assert "cbbo-waste-collection-panel-v233" in panel_js
